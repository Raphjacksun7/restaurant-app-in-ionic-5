...
import { NavController, ModalController, ToastController, Platform, LoadingController } from '@ionic/angular';
...
export class MapPage implements OnInit {
  ...
  valid() {
    if (this.selectedCoords) {
      this._storage.set('coords', JSON.stringify(this.selectedCoords));
