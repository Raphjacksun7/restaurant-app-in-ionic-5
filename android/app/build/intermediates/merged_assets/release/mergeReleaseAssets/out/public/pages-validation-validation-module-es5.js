...
var ValidationPage = /** @class */ (function () {
    function ValidationPage(navCtrl, validationService, loadingCtrl, toastCtrl, authService, route, storage) {
    ...
    ValidationPage.prototype.ngOnInit = function () {
        ...
        this.authService.getToken().then(function () {
            if (_this.authService.isLoggedIn) {
                ...
                _this.tel = _this.authService.tel;
                console.log(_this.tel);
            }
        });
        this.authService.getDistric().then(function () {
            if (_this.authService.isLoggedIn) {
                _this.userAddress = _this.authService.userAddress;
            }
        });
        this.authService.getGpsLat().then(function () {
            if (_this.authService.isLoggedIn) {
                _this.gps_lat = _this.authService.gps_lat;
            }
        });
        this.authService.getGpsLng().then(function () {
            if (_this.authService.isLoggedIn) {
                _this.gps_long = _this.authService.gps_lng;
            }
        });
    ...
    ValidationPage.prototype.ionViewWillEnter = function () {
    };
    ValidationPage.prototype.getOrders = function () {
    ...
    ValidationPage.prototype.getFraisLivraison = function () {
    ...
    ValidationPage.prototype.getCommandes = function () {
        var e_1, _a;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.commandData.panier_commande), _c = _b.next(); !_c.done; _c = _b.next()) {
                var cmd = _c.value;
    ...
    ValidationPage.prototype.commandes = function () {
        var _this = this;
    ...
    ValidationPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-validation-validation-module-es5.js.map