...
var CheckoutPage = /** @class */ (function () {
    function CheckoutPage(navCtrl, ordersService, cartService, loadingCtrl, toastCtrl, alertController, route, storage) {
    ...
    CheckoutPage.prototype.getOrders = function () {
        if (this.route.getCurrentNavigation().extras.state) {
            this.checkoutData = this.route.getCurrentNavigation().extras.state.orders;
            console.log(this.checkoutData);
        }
    };
    CheckoutPage.prototype.presentAlertPrompt = function () {
                            ...
                            buttons: [
                                {
                                    ...
                                    cssClass: 'secondary',
                                    handler: function () {
                                        Object.assign(_this.checkoutData, { "demande_monnaie": "Je ne veux pas de monnaie" });
                                        var navExtra = {
                                            state: {
                                                orders: _this.checkoutData
                                            }
                                        };
                                        _this.route.navigate(['myadress2'], navExtra);
                                        Object.assign(_this.checkoutData, { "panier_payement": "Payement à la livraison" });
                                    }
                                }, {
                                    text: 'Valider',
                                    handler: function (alertData) {
                                        if (alertData.monnaie > 0) {
                                            Object.assign(_this.checkoutData, { "demande_monnaie": "Demande de monnaie sur " + alertData.monnaie });
                                            var navExtra = {
                                                state: {
                                                    orders: _this.checkoutData
                                                }
