...
var RestaurantDetailPage = /** @class */ (function () {
    function RestaurantDetailPage(asCtrl, navCtrl, toastCtrl, modalCtrl, route, router, translate, cartService, restaurantService, dishService, loadingController) {
        this.asCtrl = asCtrl;
    ...
    RestaurantDetailPage.prototype.ngOnInit = function () {
    };
    RestaurantDetailPage.prototype.ionViewWillEnter = function () {
        this.getRestaurants();
        this.getRestaurantsById();
    };
    RestaurantDetailPage.prototype.getRestaurantsById = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.restaurantService.getRestaurantsById(this.route.snapshot.paramMap.get('id'))
                                .subscribe(function (res) {
                                console.log(res);
                                _this.menus = res.content;
                                _this.menus = JSON.parse(JSON.stringify(_this.menus));
    ...
    RestaurantDetailPage.prototype.getRestaurants = function () {
        var _this = this;
        this.restaurantService.getRestaurants()
            .subscribe(function (res) {
            _this.restaurants = res.content;
            _this.restaurants = _this.restaurants.filter(function (resto) { return resto.id === +_this.route.snapshot.paramMap.get('id'); });
            _this.restaurants = JSON.parse(JSON.stringify(_this.restaurants));
            console.log(_this.restaurants);
        }, function (err) {
            console.log(err);
        });
    };
    RestaurantDetailPage.prototype.dishDetail = function (dishId, supplements) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var e_1, _a, _b, _c, order, modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (!(supplements.length === 0)) return [3 /*break*/, 1];
                        this.restaurantService.getRestaurantsById(this.route.snapshot.paramMap.get('id'))
                            .subscribe(function (res) {
                            var e_2, _a, e_3, _b;
                            try {
                                for (var _c = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](res.content), _d = _c.next(); !_d.done; _d = _c.next()) {
                                    var dish = _d.value;
                                    try {
                                        for (var _e = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](dish.produits), _f = _e.next(); !_f.done; _f = _e.next()) {
                                            var produit = _f.value;
                                            if (produit.id === +dishId) {
                                                _this.dish = dish.produits.filter(function (prod) { return prod.id === +dishId; });
                                                _this.dish = JSON.parse(JSON.stringify(_this.dish));
                                            }
                                        }
                                    }
                        ...
                        this.cartService.addtoCart(this.dish, this.qtd, 0, []).then(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                            var toast;
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                        ...
                        try {
                            for (_b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.dish), _c = _b.next(); !_c.done; _c = _b.next()) {
                                order = _c.value;
                                this.commandes.push({
                        ...
                        this.cartService.addCommandestoCart(this.commandes).then(function (data) {
                        });
                        this.commandes = [];
                        return [3 /*break*/, 4];
    ...
    RestaurantDetailPage.prototype.message = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    RestaurantDetailPage.prototype.share = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var actionSheet;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.asCtrl.create({
    ...
    RestaurantDetailPage.prototype.range = function (n) {
        return new Array(n);
    };
    RestaurantDetailPage.prototype.openCart = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var e_4, _a, _b, _c, detail, modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_d) {
                switch (_d.label) {
                    case 0:
                        try {
                            for (_b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.restaurants), _c = _b.next(); !_c.done; _c = _b.next()) {
                                detail = _c.value;
                                this.restoData = {
                                    id: detail.id,
    ...
    RestaurantDetailPage.prototype.segmentChanged = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    RestaurantDetailPage.prototype.slideChanged = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    RestaurantDetailPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-restaurant-detail-restaurant-detail-module-es5.js.map