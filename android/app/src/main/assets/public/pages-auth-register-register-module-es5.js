...
var RegisterPage = /** @class */ (function () {
    function RegisterPage(navCtrl, menuCtrl, loadingCtrl, formBuilder, authService, alertService) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.authService.register(this.email, fullName, this.password, this.tel).subscribe(function (data) {
                            console.log(data);
                            _this.authService.usertoken(_this.email, _this.password)
