...
var LatestOrdersPageModule = /** @class */ (function () {
    function LatestOrdersPageModule() {
    }
...
var LatestOrdersPage = /** @class */ (function () {
    function LatestOrdersPage(navCtrl, ordersService) {
        this.navCtrl = navCtrl;
        this.ordersService = ordersService;
        this.lastOrders = [];
        this.getOrders();
    }
    LatestOrdersPage.prototype.getOrders = function () {
        var _this = this;
    ...
    LatestOrdersPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-latest-orders-latest-orders-module-es5.js.map