...
var AddAddressPage = /** @class */ (function () {
    function AddAddressPage(route, formBuilder, modalCtrl, address, toastController, auth, http) {
        this.route = route;
    ...
    AddAddressPage.prototype.ionViewWillEnter = function () {
        ...
        this.auth.getToken().then(function () {
            if (_this.auth.isLoggedIn) {
                ...
                _this.userData = _this.auth.userData;
            }
        });
    };
    AddAddressPage.prototype.SendAddress = function () {
        var _this = this;
    ...
    AddAddressPage.prototype.goToMap = function () {
        var _this = this;
